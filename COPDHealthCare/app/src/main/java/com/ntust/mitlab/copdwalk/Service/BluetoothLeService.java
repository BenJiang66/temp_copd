...
//            Log.d("onCharacteristicChanged", String.format("Device:%s , Data: %s \n-----------------",addr,data));
    ...
    private DEVICE_TYPE getDeviceType(String address){
        ...
        else if(address.equals(MyShared.getData(BluetoothLeService.this,DEVICE_TYPE.ENV.toString())))
            return DEVICE_TYPE.ENV;
        else {
...
//        return true;
    ...
    public void sendData2(String address, String data){
        writeCharacteristic(data.getBytes(), address, DEVICE_TYPE.ENV);
    }
    ...
    private void writeCharacteristic(byte[] data, String address,DEVICE_TYPE type)
    {
        ...
        else if (type==DEVICE_TYPE.WATCH){
