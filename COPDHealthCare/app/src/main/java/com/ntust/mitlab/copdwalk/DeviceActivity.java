...
public class DeviceActivity extends AppCompatActivity {
    ...
    private String deviceAddr_Watch,deviceAddr_SPO2, deviceID_ENV, deviceAddr_ENV;
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                switch (deviceType){
                    ...
                    case SPO2:
                        ...
                        break;
                    case ENV:
                        deviceAddr_ENV = device.getAddress();
                        MyShared.setData(DeviceActivity.this, DEVICE_TYPE.ENV.toString(), deviceAddr_ENV);
                        if(mBluetoothLeService!=null){
                            try {
                                mBluetoothLeService.connectGatt(deviceAddr_ENV);

                                mThread = new HandlerThread("t1");
                                mThread.start();
                                final Handler mHandler = new Handler(mThread.getLooper());
                                mHandler.post(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        mBluetoothLeService.sendData2(deviceAddr_ENV,"a" );
                                        mHandler.postDelayed(this, 290 * 1000);
                                    }
                                });
            ...
            switch (v.getId()){
                ...
                case R.id.connect_env_sensor:
                    ...
                    if(!isDeviceConnect(deviceType)){
                        ...
                        String addr = MyShared.getData(DeviceActivity.this, DEVICE_TYPE.ENV.toString());
                        mBluetoothLeService.disconnectGatt(addr);
