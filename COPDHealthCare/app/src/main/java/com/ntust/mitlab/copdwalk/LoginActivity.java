...
//                        progressBar.setVisibility(View.INVISIBLE);
    ...
    private void setupDaily(String result){
        ...
        try {
            ...
            for(int i=0; i<jsonArray.length(); i++) {
                ...
                dbHelper.saveDaily(date, step, h_i_time, distance, 1);
            }
    ...
    public void setupProfile(String data) {
        try {
            ...
            MyShared.setData(this,"StepGoal", "3500");//should sync from cloud
            MyShared.setData(this,"StepGoal_check_date", "0");//if clear data, it will ask at first time
